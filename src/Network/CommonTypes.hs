...
data LossFunction m where
    LossFunction :: { unLossF :: Vector m (Dual Output)
                              -> Vector m (Dual Output)
                              -> Dual Number
                    } -> LossFunction m


data TotalLossFunction m o where
    TotalLossFunction :: { unTotLossF :: Vector m (Vector o Output)
                                      -> Vector m (Vector o Output)
                                      -> Output
                         } -> TotalLossFunction m o
